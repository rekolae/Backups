...
--
-- Created:
--          by - kayra.UNKNOWN (HTC219-719-SPC)
...
ARCHITECTURE struct OF HELLO_LED IS
   ...
   COMPONENT c1_t3_hello_led_combined
   PORT (
      btn       : IN     std_logic_vector (3 DOWNTO 0);
      sw0       : IN     std_logic ;
   ...
   FOR ALL : c1_t3_hello_led_combined USE ENTITY alien_game_lib.c1_t3_hello_led_combined;
