/****************************************************************************
** Meta object code from reading C++ file 'card.hh'
**
...
#include "../korttipeli/card.hh"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'card.hh' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 14, 4), // "turn"
QT_MOC_LITERAL(4, 19, 6) // "expand"

    },
    "Card\0resized\0\0turn\0expand"
};
...
void Card::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Card::resized)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Card::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_Card.data,
